...
Table02_15Property::Table02_15Property(RB_ObjectContainer *inputOutput)
...
void Table02_15Property::createList() {
    ...
    // Table 03
    cl(1.0, "3-3-100-1", 40.0, 20.0, 10.0, 10.0);
    cl(1.0, "3-3-100-1", 40.0, 40.0, 10.0, 10.0);
    cl(1.0, "3-3-100-1", 40.0, 60.0, 10.0, 10.0);
    cl(1.0, "3-3-100-1", 40.0, 80.0, 10.0, 10.0);
    cl(1.0, "3-3-100-1", 40.0, 100.0, 10.0, 10.0);
    cl(1.0, "3-3-100-1", 40.0, 160.0, 10.0, 10.0);
    cl(1.0, "3-3-100-1", 40.0, 320.0, 10.0, 10.0);
    cl(1.0, "3-3-100-1", 80.0, 320.0, 10.0, 10.0);
    cl(1.0, "3-3-100-1", 160.0, 1600.0, 10.0, 10.0);
    cl(0.1, "3-3-100-1", 40.0, 40.0, 16.0, 10.0);
    cl(0.1, "3-3-100-1", 40.0, 60.0, 16.0, 10.0);
    cl(0.1, "3-3-100-1", 40.0, 80.0, 16.0, 10.0);
    cl(0.1, "3-3-100-1", 40.0, 100.0, 16.0, 10.0);
    cl(0.1, "3-3-100-1", 40.0, 160.0, 16.0, 10.0);
    cl(0.1, "3-3-100-1", 40.0, 320.0, 16.0, 10.0);
    cl(0.1, "3-3-100-1", 80.0, 320.0, 32.0, 10.0);
    cl(0.1, "3-3-100-1", 160.0, 160.0, 20.0, 10.0);
    cl(0.01, "3-3-100-1", 40.0, 40.0, 25.0, 10.0);
    cl(0.01, "3-3-100-1", 40.0, 60.0, 25.0, 10.0);
    cl(0.01, "3-3-100-1", 40.0, 80.0, 25.0, 10.0);
    cl(0.01, "3-3-100-1", 40.0, 100.0, 25.0, 10.0);
    cl(0.01, "3-3-100-1", 40.0, 160.0, 25.0, 10.0);
    cl(0.01, "3-3-100-1", 40.0, 320.0, 25.0, 10.0);
    cl(0.01, "3-3-100-1", 80.0, 320.0, 48.0, 10.0);
    cl(0.01, "3-3-100-1", 160.0, 160.0, 45.0, 10.0);
    cl(0.001, "3-3-100-1", 40.0, 60.0, 42.0, 16.0);
    cl(0.001, "3-3-100-1", 40.0, 80.0, 42.0, 18.0);
    cl(0.001, "3-3-100-1", 40.0, 100.0, 42.0, 17.0);
    cl(0.001, "3-3-100-1", 40.0, 160.0, 42.0, 10.0);
    cl(0.001, "3-3-100-1", 40.0, 320.0, 42.0, 10.0);
    cl(0.001, "3-3-100-1", 80.0, 320.0, 81.0, 15.0);
    cl(0.001, "3-3-100-1", 160.0, 160.0, 83.0, 31.0);
    cl(0.0001, "3-3-100-1", 40.0, 100.0, 81.0, 62.0);
    cl(0.0001, "3-3-100-1", 40.0, 160.0, 81.0, 35.0);
    cl(0.0001, "3-3-100-1", 40.0, 320.0, 81.0, 26.0);
    cl(0.0001, "3-3-100-1", 80.0, 320.0, 143.0, 51.0);
    cl(0.0001, "3-3-100-1", 160.0, 160.0, 159.0, 157.0);
    cl(0.00001, "3-3-100-1", 40.0, 320.0, 181.0, 83.0);
    cl(0.00001, "3-3-100-1", 80.0, 320.0, 281.0, 198.0);
    cl(0.000001, "3-3-100-1", 40.0, 320.0, 314.0, 298.0);
    // Table 04
