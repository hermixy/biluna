 ...
 * \li type_id material or form type ID: BAR, BOLTING, CASTING, FITTING, FORGING, NUT, PIPE, PLATE, ROD, TUBE
 * \li class_id material class ID: CARBON STEEL, HIGH ALLOY, LOW ALLOY, STAINLESS STEEL, NON FERRO'S
...
void STD_Material::createMembers() {
    ...
    addMember("type_id", "-", "", RB2::MemberChar40);
    addMember("class_id", "-", "", RB2::MemberChar40);
