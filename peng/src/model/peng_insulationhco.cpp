/*****************************************************************
 * $Id: peng_insulationhco.cpp 2165 2014-09-24 19:22:36Z rutger $
...
PENG_InsulationHCO::PENG_InsulationHCO (const RB_String& id, RB_ObjectBase* p,
...
PENG_InsulationHCO::PENG_InsulationHCO(PENG_InsulationHCO* obj) : RB_ObjectAtomic(obj) {
    createMembers();
    *this = *obj;
}


PENG_InsulationHCO::~PENG_InsulationHCO() {
 ...
 */
void PENG_InsulationHCO::createMembers() {
