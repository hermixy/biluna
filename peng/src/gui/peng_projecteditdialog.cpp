 ...
 */
PENG_ProjectEditDialog::PENG_ProjectEditDialog(QWidget *parent)
        : RB_ProjectEditDialog(parent) {
    // Write settings, otherwise RB_ProjectEditDialog
    this->setObjectName("PENG_ProjectEditDialog");
}

/**
 * Destructor
 */
PENG_ProjectEditDialog::~PENG_ProjectEditDialog() {
    RB_DEBUG->print("PENG_ProjectEditDialog::~PENG_ProjectEditDialog() OK");
}

/**
 * Initialize the dialog with model
 */
void PENG_ProjectEditDialog::init() {
 ...
 * Button add clicked
 */
void PENG_ProjectEditDialog::on_pbAdd_clicked() {
    if (!mModel) return;
