/*****************************************************************
 * $Id: srm_contactreportwidget.h 2132 2014-03-29 09:59:36Z rutger $
...
#ifndef SRM_CONTACTREPORTWIDGET_H
#define SRM_CONTACTREPORTWIDGET_H

#include "srm_reportwidget.h"
#include "ui_srm_contactreportwidget.h"
 ...
 */
class SRM_ContactReportWidget : public SRM_ReportWidget, private Ui::SRM_ContactReportWidget {

    Q_OBJECT

public:
    explicit SRM_ContactReportWidget(QWidget *parent = 0);
    virtual ~SRM_ContactReportWidget();
...
#endif // SRM_CONTACTREPORTWIDGET_H
