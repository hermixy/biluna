/*****************************************************************
 * $Id: srm_reportwidget.cpp 2200 2014-12-15 10:44:04Z rutger $
 ...
 * Constructor
 */
SRM_ReportWidget::SRM_ReportWidget(QWidget *parent)
                        : RB_Widget(parent) {
    // setupUi(this);
 ...
 * Destructor
 */
SRM_ReportWidget::~SRM_ReportWidget() {
    // nothing
}
 ...
 */
bool SRM_ReportWidget::fileSave(bool /*withSelect*/) {
 ...
 */
bool SRM_ReportWidget::fileSaveAs() {
 ...
 * @param printer
 */
void SRM_ReportWidget::filePdf(QPrinter* printer) {
 ...
 * @param printer
 */
void SRM_ReportWidget::filePrint(QPrinter* printer) {
    mTeReport->print(printer);
}
 ...
 * @param printer
 */
void SRM_ReportWidget::filePrintPreview(QPrinter* printer) {
    mTeReport->print(printer);
}
 ...
 */
bool SRM_ReportWidget::saveFile(const RB_String &fn) {
    QFile file(fn);
 ...
 */
void SRM_ReportWidget::createReport(RB_String& html,
 ...
 * @param list container with list of data objects
 */
void SRM_ReportWidget::createReport(RB_String& html, QSqlQuery& query) {
 ...
 */
void SRM_ReportWidget::setReportHeader(RB_String& html) {
 ...
 * @param html HTML to be set
 */
void SRM_ReportWidget::setDataHeader(RB_String& html) {
    // nothing
}
 ...
 * @param obj data object
 */
void SRM_ReportWidget::setDataRow(RB_String& html, RB_ObjectBase* obj) {
    int colRunner = 0;
    int rowRunner = 0;
 ...
 * @param rec database query record
 */
void SRM_ReportWidget::setDataRow(QString &html, const QSqlRecord &rec) {
    int colRunner = 0;
    int rowRunner = 0;
 ...
 * @param html HTML to be set
 */
void SRM_ReportWidget::setDataFooter(RB_String& html) {
    // nothing
}
 ...
 * @param html HTML to be set
 */
void SRM_ReportWidget::setTableFooter(RB_String& html) {
    html += "</tbody></table>";
}
 ...
 * @param html HTML to be set
 */
void SRM_ReportWidget::setReportFooter(RB_String& html) {
