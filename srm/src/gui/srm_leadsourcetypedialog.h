/*****************************************************************
 * $Id: srm_leadsourcetypedialog.h 1965 2013-08-08 16:33:15Z rutger $
...
#ifndef SRM_LEADSOURCETYPEDIALOG_H
#define SRM_LEADSOURCETYPEDIALOG_H
...
class SRM_LeadSourceTypeDialog : public DB_TableDialog {

    Q_OBJECT

public:
    SRM_LeadSourceTypeDialog(QWidget* parent) : DB_TableDialog(parent) {
        // HACK: for write settings otherwise RB_DialogBase
        this->setObjectName("SRM_LeadSourceTypeDialog");
    }

    virtual ~SRM_LeadSourceTypeDialog() {
...
//        this->initTest();
        ...
        this->setHelpSubject("SRM_LeadSourceTypeDialog");
...
#endif // SRM_LEADSOURCETYPEDIALOG_H
