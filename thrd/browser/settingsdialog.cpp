...
void SettingsDialog::loadFromSettings()
{
    ...
    const QString defaultHome = QLatin1String(DB_InternetBrowserWidget::defaultHome);
...
{
    DB_InternetBrowserWidget* w = static_cast<DB_InternetBrowserWidget*>(parent());
    WebView *webView = w->currentTab();
    if (webView)
