/****************************************************************************
** $Id: rs_modification.h 8592 2008-01-29 20:23:59Z andrew $
**
...
public:
    ...
    RS_PasteData(RS_Vector insertionPoint,
        ...
        this->useCurrentLayer = useCurrentLayer;
    }
    ...
    //! Flip horizontal
    bool flipHorizontal;
    //! Use current layer instead of original layer
    bool useCurrentLayer;
};
...
public:
    ...
    void remove();
    void moveToBack(bool toBack = true);
...
public:
    ...
    void duplicateLayer(RS_Layer* originalLayer);

    bool changeProperty(const RS_String& name, const RS_Variant& value);
    ...
    bool isoProject(RS_IsoProjectData& data);
    ...
    bool divide(const RS_Vector& cutCoord, RS_AtomicEntity* cutEntity);
    bool divide2(RS_AtomicEntity* cutEntity, const RS_Vector& cursor, bool remove=true);
    bool divide2(const RS_Vector& cutCoord1, const RS_Vector& cutCoord2, 
        RS_AtomicEntity* cutEntity, const RS_Vector& cursor, bool remove=true);
    ...
    RS_Polyline* deletePolylineNode(RS_Polyline& polyline, 
                const RS_Vector& node);
    RS_Polyline* deletePolylineNodesBetween(RS_Polyline& polyline, 
    ...
    RS_Polyline* segmentsToPolyline(RS_AtomicEntity& segment);

#ifdef RS_ALGO
    bool triangulate();
    bool doBooleanOperation(BooleanOperation op/*, bool orientationEntryMode=false*/);
#endif

private:
    void deselectOriginals(bool remove, bool onlyVisibleSelections=false);
