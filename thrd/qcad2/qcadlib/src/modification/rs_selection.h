/****************************************************************************
** $Id: rs_selection.h 9397 2008-03-12 19:50:35Z andrew $
**
...
public:
    ...
    void selectSingle(RS_Entity* e, bool updateView=true);
    void selectAll(bool select=true, bool updateView=true);
    void deselectAll(bool updateView=true) {
        selectAll(false, updateView);
    }
