...
public:
     ...
     */
    virtual RS_Painter* createSimPainter() = 0;
    /**
    ...
    virtual bool isVisible(RS_Entity* e);
    virtual void drawEntity(RS_Entity* e, double patternOffset=0.0, bool db=false);
    virtual void drawEntityHandles(RS_Entity* e);
    ...
    void prepareSimulationPreview(const RS_Vector& pos);
    ...
    void setDefaultSnapMode(RS2::ActionType sm);
    RS2::ActionType getDefaultSnapMode() {
        return defaultSnapMode;
    }
    void setSnapRestriction(RS2::ActionType sr);
    RS2::ActionType getSnapRestriction() {
        //return defaultSnapRes;
        return RS2::ActionRestrictNothing;
    }
     ...
     */
    inline RS_Vector toGui(const RS_Vector& v) {
    ...
    RS_Vector toGraph(const RS_Vector& v);
