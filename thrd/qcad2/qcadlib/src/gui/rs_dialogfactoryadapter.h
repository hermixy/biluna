/****************************************************************************
** $Id: rs_dialogfactoryadapter.h 10352 2008-04-06 19:25:15Z andrew $
**
...
public:
...
#endif
    virtual void requestWindowResize(int , int ) {}
    ...
    virtual void requestOptions(RS_ActionInterface* , 
        bool , bool = false) {}
    virtual void requestSnapOptions(RS_Snapper* , bool ) {}
...
#endif
    virtual bool requestOneTimeDialog(const RS_String&, const RS_String&) { return false; }
    virtual void enablePropertyEditor(bool ) {}
    virtual void updatePropertyEditor(RS_PropertyOwner* , bool ) {}
    virtual void updatePropertyEditor(RS_PropertyOwnerContainerInterface* , bool) {}
    ...
    //virtual void addWidgetToOptionWidget(RS_Widget*) {}
};
