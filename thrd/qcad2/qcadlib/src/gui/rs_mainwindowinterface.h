/****************************************************************************
** $Id: rs_mainwindowinterface.h 6441 2007-09-19 08:40:35Z andrew $
**
...
public:
    ...
    virtual void graphicViewRedrawn() = 0;

    virtual void createNewDocument(
        const RS_String& fileName = RS_String::null, RS_Document* doc=NULL) = 0;
    virtual void loadDocument(const RS_String& fileName) = 0;
    virtual void closeDocument() = 0;
    virtual void saveDocument(const RS_String& fileName) = 0;
#ifdef RS_CAM
