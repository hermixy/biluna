...
public:
    ...
    virtual void drawArc(const RS_Vector& cp, double radius,
                         double a1, double a2,
                         bool reversed) = 0;
    void createArc(RS_PointArray& pa,
                   const RS_Vector& cp, double radius,
                   double a1, double a2,
                   bool reversed);
    void createEllipseArc(RS_PointArray& pa,
                   const RS_Vector& cp, 
    ...
    */
    ...
    virtual void setBackground(const RS_Color& color) = 0;
    ...
    inline int toScreenX(double x) {
        return RS_Math::mround(offset.x + x);
    }
    inline int toScreenY(double y) {
        return RS_Math::mround(offset.y + y);
    }
