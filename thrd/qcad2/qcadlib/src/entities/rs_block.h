/****************************************************************************
** $Id: rs_block.h 6363 2007-09-14 16:45:12Z andrew $
**
...
public:
     ...
     */
    RS_Block(RS_EntityContainer* parentContainer, const RS_BlockData& d);
    ...
    virtual bool isOfType(RS2::EntityType t) const {
        return (t==RS2::EntityBlock || RS_Document::isOfType(t));
    }
     ...
     * Reimplementation from RS_Document. Does nothing.
     */
    virtual bool open(const RS_String& , RS2::FormatType, bool = true) {
        // do nothing
        return false;
    }
