/****************************************************************************
** $Id: rs_constructionline.cpp 7925 2008-01-17 18:01:07Z andrew $
**
 ...
 * Constructor.
 */
RS_ConstructionLine::RS_ConstructionLine(RS_EntityContainer* parentContainer,
...
RS_Entity* RS_ConstructionLine::clone() {
    RS_ConstructionLine* c = new RS_ConstructionLine(parentContainer, data);
...
void RS_ConstructionLine::calculateBorders(bool /*visibleOnly*/) {
...
double RS_ConstructionLine::getDistanceToPoint(const RS_Vector& coord,
        RS_Entity** entity,
        RS2::ResolveLevel /*level*/, double /*solidDist*/, bool /*visually*/) {
