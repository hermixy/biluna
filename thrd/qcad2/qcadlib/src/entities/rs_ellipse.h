/****************************************************************************
** $Id: rs_ellipse.h 7898 2008-01-15 17:26:19Z andrew $
**
...
#define RS_ELLIPSE_CENTER_X QObject::tr(RS_Ellipse::propertyCenterX)
#define RS_ELLIPSE_CENTER_Y QObject::tr(RS_Ellipse::propertyCenterY)
#define RS_ELLIPSE_MAJORP_X QObject::tr(RS_Ellipse::propertyMajorPX)
#define RS_ELLIPSE_MAJORP_Y QObject::tr(RS_Ellipse::propertyMajorPY)
#define RS_ELLIPSE_RATIO QObject::tr(RS_Ellipse::propertyRatio)
#define RS_ELLIPSE_STARTANGLE QObject::tr(RS_Ellipse::propertyStartangle)
#define RS_ELLIPSE_ENDANGLE QObject::tr(RS_Ellipse::propertyEndangle)
#define RS_ELLIPSE_REVERSED QObject::tr(RS_Ellipse::propertyReversed)
...
public:
    ...
    virtual RS_Entity* clone() {
        RS_Ellipse* e = new RS_Ellipse(parentContainer, data);
    ...
    virtual bool isOfType(RS2::EntityType t) const {
        return (t==RS2::EntityEllipse || RS_AtomicEntity::isOfType(t));
    }
    ...
    bool isFullEllipse() {
        return (RS_Math::correctAngle(data.angle1)<1.0e-6 && 
            RS_Math::correctAngle(data.angle2)>2*M_PI-1.0e-6) ||
            (fabs(RS_Math::correctAngle(data.angle1) - 
                  RS_Math::correctAngle(data.angle2))<1.0e-4);
    }
    ...
    RS_Vector getMinorP() {
        double angle = RS_Math::correctAngle(getAngle() + M_PI/2.0);
        RS_Vector ret;
        ret.setPolar(getMinorRadius(), angle);
        return ret;
    }

    void setMinorP(const RS_Vector& p) {
        double angle = RS_Math::correctAngle(p.angle() - M_PI/2.0);
    ...
    RS_Polyline* approximateWithArcs(int segments);
