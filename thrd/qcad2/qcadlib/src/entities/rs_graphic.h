/****************************************************************************
** $Id: rs_graphic.h 8803 2008-02-01 18:18:52Z andrew $
**
...
public:
    ...
    virtual bool isOfType(RS2::EntityType t) const {
        return (t==RS2::EntityGraphic || RS_Document::isOfType(t));
    }
    virtual RS_String typeName() const {
        return QObject::tr("Graphic");
    }

    virtual int countLayerEntities(RS_Layer* layer);
    ...
    virtual bool open(const RS_String& filename, RS2::FormatType type, bool clean=true);
    ...
    void addLayerListListeners(RS_List<RS_LayerListListener*>& listeners) {
