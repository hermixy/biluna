/****************************************************************************
** $Id: rs_block.cpp 7930 2008-01-17 21:23:04Z andrew $
**
 ...
 */
RS_Block::RS_Block(RS_EntityContainer* parentContainer,
                   const RS_BlockData& d)
        : RS_Entity(parentContainer), RS_Document(parentContainer), data(d) {
    RS_DEBUG->print("RS_Block::RS_Block");

    pen = RS_Pen(RS_Color(128,128,128), RS2::Width01, RS2::SolidLine);
    
    RS_DEBUG->print("RS_Block::RS_Block: OK");
}
...
RS_Entity* RS_Block::clone() {
    RS_Block* blk = new RS_Block(parentContainer, data);
