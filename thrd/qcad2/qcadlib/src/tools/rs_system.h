/****************************************************************************
** $Id: rs_system.h 9244 2008-02-28 18:37:58Z andrew $
**
...
public:
    ...
    static RS_String getEnvironmentVariable(
        const RS_String& name, const RS_String& def=RS_String());

    /**
     * @return Users home directory.
     */
    static RS_String getHomeDir() {
