/****************************************************************************
** $Id: rs_units.cpp 7898 2008-01-15 17:26:19Z andrew $
**
...
RS_String RS_Units::unitToString(RS2::Unit u, bool t) {
    ...
    case RS2::Parsec:
        ...
        break;
    case RS2::Plu:
        ret = t ? QObject::tr("Plu") : RS_String("Plu");
        break;
...
RS_String RS_Units::formatLinear(double length, RS2::Unit unit,
    ...
    RS_DEBUG->print("RS_Units::formatLinear");
    ...
    RS_DEBUG->print("RS_Units::formatLinear: OK");
...
RS_String RS_Units::formatScientific(double length, RS2::Unit unit,
    ...
    RS_DEBUG->print("RS_Units::formatScientific");
    ...
    RS_DEBUG->print("RS_Units::formatScientific: OK");
...
RS_String RS_Units::formatDecimal(double length, RS2::Unit unit,
    ...
    RS_DEBUG->print("RS_Units::formatDecimal");
    ...
    */
    ...
    RS_DEBUG->print("RS_Units::formatDecimal: OK");
...
RS_String RS_Units::formatFractional(double length, RS2::Unit /*unit*/,
    ...
    nominator = RS_Math::mround((length-num)*denominator);
...
RS_String RS_Units::formatAngle(double angle, RS2::AngleFormat format,
    ...
    case RS2::Radians:
    case RS2::Gradians:
        ret = RS_Math::doubleToString(value, prec, showLeadingZeroes, showTrailingZeroes);
...
RS_String RS_Units::trimTrailingZeroes(const RS_String& s) {
    RS_String ret = s;
