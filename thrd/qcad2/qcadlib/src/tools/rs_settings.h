/****************************************************************************
** $Id: rs_settings.h 5739 2007-07-02 14:22:01Z andrew $
**
...
public:
    ...
    RS_String readEntry(const RS_String& key,
                        ...
                        bool* ok = 0);
    double readDoubleEntry(const RS_String& key,
                        double def = 0.0,
                        bool* ok = 0);
    ...
    RS_Variant value(const RS_String& key, 
        const RS_Variant& defaultValue = RS_Variant());
    void setValue(const RS_String& key, const RS_Variant& value);
...
protected:
    ...
    RS_Hash<RS_String, RS_String> cache;
