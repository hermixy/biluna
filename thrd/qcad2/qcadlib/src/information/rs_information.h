/****************************************************************************
** $Id: rs_information.h 7816 2008-01-04 16:57:10Z andrew $
**
...
public:
    ...
    static RS_VectorList getIntersection(RS_Entity* e1,
            RS_Entity* e2,
            bool onEntities = false);

    static RS_VectorList getIntersectionLineLine(RS_Line* e1,
            RS_Line* e2);

    static RS_VectorList getIntersectionLineArc(RS_Line* line,
            RS_Arc* arc);

    static RS_VectorList getIntersectionArcArc(RS_Arc* e1,
            RS_Arc* e2);
    
    static RS_VectorList getIntersectionLineEllipse(RS_Line* line,
            RS_Ellipse* ellipse);
    ...
    static bool isOverlapping(const RS_Vector& r1v1, const RS_Vector& r1v2,
