 ...
 */
class CAD_EXPORT QG_MouseWidget: public QWidget, private Ui::QG_MouseWidget {
    Q_OBJECT

public:
    QG_MouseWidget(QWidget* parent=0);
    virtual ~QG_MouseWidget();

    void setHelp(const QString& left, const QString& right);
private:
};
