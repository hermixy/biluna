 ...
 *
 */
class CAD_EXPORT QG_LineRelAngleOptions: public QG_OptionsBase, 
                              private Ui::QG_LineRelAngleOptions {
    Q_OBJECT

public:
    QG_LineRelAngleOptions(QWidget* parent=0);
    virtual ~QG_LineRelAngleOptions();
