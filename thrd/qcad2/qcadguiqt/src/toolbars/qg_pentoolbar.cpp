/****************************************************************************
** $Id: qg_pentoolbar.cpp 5606 2007-06-10 21:15:49Z andrew $
**
 ...
 * to a layer list.
 */
void QG_PenToolBar::slotLayerActivated(RS_Layer* l) {
