/****************************************************************************
** $Id: rs_actionmodifytrim.h 6522 2007-09-25 12:56:52Z andrew $
**
...
#ifndef RS_ACTIONMODIFYTRIMBOTH_H
#define RS_ACTIONMODIFYTRIMBOTH_H
...
public:
    ...
    ~RS_ActionModifyTrimBoth() {}

    static RS_String getName() {
        return "Modify Trim Both";
    }

    virtual RS_String name() {
        return RS_ActionModifyTrimBoth::getName();
    }
