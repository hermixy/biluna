/****************************************************************************
** $Id: rs_actionmodifymoverotate.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionModifyMoveRotate : public RS_ActionBase {
    Q_OBJECT
public:
    /**
     * Action States.
...
public:
    ...
    static RS_String getName() {
        return "Modify Move Rotate";
    }

    virtual RS_String name() {
        return RS_ActionModifyMoveRotate::getName();
    }
