/****************************************************************************
** $Id: rs_actionmodifyscale.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionModifyScale : public RS_ActionBase {
    Q_OBJECT
public:
    /**
     * Action States.
...
public:
    ...
    virtual RS_String name() {
        return RS_ActionModifyScale::getName();
    }
