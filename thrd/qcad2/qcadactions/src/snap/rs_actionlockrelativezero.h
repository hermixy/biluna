/****************************************************************************
** $Id: rs_actionlockrelativezero.h 10343 2008-04-06 17:43:02Z andrew $
**
...
public:
    RS_ActionLockRelativeZero(RS_EntityContainer& container,
                             ...
                             bool on, bool toggle=false);
    ~RS_ActionLockRelativeZero() {}

    static RS_String getName() {
        return "Lock Relative Zero";
    }

    virtual RS_String name() {
        return RS_ActionLockRelativeZero::getName();
    }

    static RS_GuiAction* createGuiAction();
    static RS_ActionInterface* factory();
    static void updateGuiAction();
