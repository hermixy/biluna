/****************************************************************************
** $Id: rs_actionsetrelativezero.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionSetRelativeZero : public RS_ActionBase {
    Q_OBJECT
public:
    ...
    static RS_String getName() {
        return "Set Relative Zero";
    }

    virtual RS_String name() {
        return RS_ActionSetRelativeZero::getName();
    }
