/****************************************************************************
** $Id: rs_actiondrawlineparallelthrough.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionDrawLineParallelThrough : public RS_ActionBase {
    Q_OBJECT
private:
    enum Status {
...
public:
    ...
    static RS_String getName() {
        return "Draw Line Parallel Through";
    }

    virtual RS_String name() {
        return RS_ActionDrawLineParallelThrough::getName();
    }
