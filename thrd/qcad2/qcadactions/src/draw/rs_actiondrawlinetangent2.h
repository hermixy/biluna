/****************************************************************************
** $Id: rs_actiondrawlinetangent2.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionDrawLineTangent2 : public RS_ActionBase {
    Q_OBJECT
private:
    enum Status {
...
public:
    ...
    static RS_String getName() {
        return "Draw Line Tangent 2";
    }

    virtual RS_String name() {
        return RS_ActionDrawLineTangent2::getName();
    }
