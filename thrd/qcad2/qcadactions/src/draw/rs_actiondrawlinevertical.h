...
#ifndef RS_ACTIONDRAWLINEVERTICAL_H
#define RS_ACTIONDRAWLINEVERTICAL_H
...
public:
    ...
    virtual ~RS_ActionDrawLineVertical();

    static RS_String getName() {
        return "Draw Line Vertical";
    }

    virtual RS_String name() {
        return RS_ActionDrawLineVertical::getName();
    }
