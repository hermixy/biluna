/****************************************************************************
** $Id: rs_actiondrawlineparallel.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionDrawLineParallel : public RS_ActionBase {
    Q_OBJECT
private:
    enum Status {
...
public:
    ...
    static RS_String getName() {
        return "Draw Line Parallel";
    }

    virtual RS_String name() {
        return RS_ActionDrawLineParallel::getName();
    }
