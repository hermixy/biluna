/****************************************************************************
** $Id: rs_actiondrawlinebisector.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionDrawLineBisector : public RS_ActionBase {
    Q_OBJECT
private:
    enum Status {
...
public:
    ...
    static RS_String getName() {
        return "Draw Line Bisector";
    }

    virtual RS_String name() {
        return RS_ActionDrawLineBisector::getName();
    }
