/****************************************************************************
** $Id: rs_actionselectall.h 10341 2008-04-06 17:41:55Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionSelectAll : public RS_ActionSelectBase {
    Q_OBJECT
public:
    ...
    virtual RS_String name() {
        return RS_ActionSelectAll::getName();
    }
