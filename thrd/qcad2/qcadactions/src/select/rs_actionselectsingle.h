/****************************************************************************
** $Id: rs_actionselectsingle.h 10341 2008-04-06 17:41:55Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionSelectSingle : public RS_ActionSelectBase {
    Q_OBJECT
public:
    ...
    virtual RS_String name() {
        return RS_ActionSelectSingle::getName();
    }
