/****************************************************************************
** $Id: rs_actioninfototallength.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionInfoTotalLength : public RS_ActionInterface {
    Q_OBJECT
public:
    /**
     * Action States.
...
public:
    ...
    static RS_String getName() {
        return "Info Total Length";
    }

    virtual RS_String name() {
        return RS_ActionInfoTotalLength::getName();
    }
