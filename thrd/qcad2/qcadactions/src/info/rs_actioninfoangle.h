/****************************************************************************
** $Id: rs_actioninfoangle.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionInfoAngle : public RS_ActionInterface {
    Q_OBJECT
public:
    /**
     * Action States.
...
public:
    ...
    virtual RS_String name() {
        return RS_ActionInfoAngle::getName();
    }
