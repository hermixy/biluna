/****************************************************************************
** $Id: rs_actionfilesaveas.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionFileSaveAs : public RS_ActionInterface {
    Q_OBJECT
public:
    ...
    virtual RS_String name() {
        return RS_ActionFileSaveAs::getName();
    }
