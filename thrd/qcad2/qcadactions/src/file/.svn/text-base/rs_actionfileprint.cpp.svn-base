...
RS_ActionFilePrint::RS_ActionFilePrint(RS_EntityContainer& container,
                                     RS_GraphicView& graphicView)
        :RS_ActionInterface( container, graphicView) {}


RS_GuiAction* RS_ActionFilePrint::createGuiAction() {
    static RS_GuiAction* action = NULL;

    if (action==NULL) {
        action = new RS_GuiAction(RS_ActionFilePrint::getName(), 
            "fileprint",
                             tr("&Print..."));
