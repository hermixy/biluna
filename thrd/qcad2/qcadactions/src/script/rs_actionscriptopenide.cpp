...
RS_ActionScriptOpenIde::RS_ActionScriptOpenIde(RS_EntityContainer& container,
                                     RS_GraphicView& graphicView)
        :RS_ActionInterface( container, graphicView) {}


RS_GuiAction* RS_ActionScriptOpenIde::createGuiAction() {
    static RS_GuiAction* action = NULL;

    if (action==NULL) {
        action = new RS_GuiAction(RS_ActionScriptOpenIde::getName(),tr("&Open IDE"));
