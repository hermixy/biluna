/****************************************************************************
** $Id: rs_actiondimradial.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionDimRadial : public RS_ActionDimension {
    Q_OBJECT
private:
    enum Status {
...
public:
    ...
    static RS_String getName() {
        return "Draw Radial Dimension";
    }

    virtual RS_String name() {
        return RS_ActionDimRadial::getName();
    }
