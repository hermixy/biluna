/****************************************************************************
** $Id: rs_actiontoolregeneratedimensions.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionToolRegenerateDimensions : public RS_ActionInterface {
    Q_OBJECT
public:
    ...
    static RS_String getName() {
        return "Regenerate Dimensions";
    }

    virtual RS_String name() {
        return RS_ActionToolRegenerateDimensions::getName();
    }
