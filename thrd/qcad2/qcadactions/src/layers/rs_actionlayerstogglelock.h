/****************************************************************************
** $Id: rs_actionlayerstogglelock.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionLayersToggleLock : public RS_ActionInterface {
    Q_OBJECT
public:
    ...
    static RS_String getName() {
        return "Layers Toggle Lock";
    }

    virtual RS_String name() {
        return RS_ActionLayersToggleLock::getName();
    }
