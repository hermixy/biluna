/****************************************************************************
** $Id: rs_actionlayersremove.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionLayersRemove : public RS_ActionInterface {
    Q_OBJECT
public:
    ...
    virtual RS_String name() {
        return RS_ActionLayersRemove::getName();
    }
