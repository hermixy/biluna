/****************************************************************************
** $Id: rs_actionblockstoggleview.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionBlocksToggleView : public RS_ActionInterface {
    Q_OBJECT
public:
    ...
    static RS_String getName() {
        return "Toggle Block Visibility";
    }

    virtual RS_String name() {
        return RS_ActionBlocksToggleView::getName();
    }
