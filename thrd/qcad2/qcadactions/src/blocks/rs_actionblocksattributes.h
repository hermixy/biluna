/****************************************************************************
** $Id: rs_actionblocksattributes.h 10343 2008-04-06 17:43:02Z andrew $
**
 ...
 */
class CAD_EXPORT RS_ActionBlocksAttributes : public RS_ActionInterface {
  Q_OBJECT
public:
    ...
    static RS_String getName() {
        return "Edit Block Attributes";
    }

    virtual RS_String name() {
        return RS_ActionBlocksAttributes::getName();
    }
