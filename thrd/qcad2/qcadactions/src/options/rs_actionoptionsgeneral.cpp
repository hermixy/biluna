...
RS_ActionOptionsGeneral::RS_ActionOptionsGeneral(RS_EntityContainer& container,
                                     RS_GraphicView& graphicView)
        :RS_ActionInterface( container, graphicView) {}


RS_GuiAction* RS_ActionOptionsGeneral::createGuiAction() {
    static RS_GuiAction* action = NULL;

    if (action==NULL) {
        action = new RS_GuiAction(RS_ActionOptionsGeneral::getName(), /*QIcon("configure.png"),*/
#ifdef __APPLE__
                             tr("&Preferences")
#else
