...
void SettingsDialog::loadFromSettings()
{
    ...
    QString defaultHome = QLatin1String("http://www.biluna.com/");
    ...
    CookieJar *jar = DB_InternetBrowserFactory::cookieJar();
...
void SettingsDialog::saveToSettings()
{
    ...
    DB_InternetBrowserFactory::getInstance()->loadSettings();
    DB_InternetBrowserFactory::networkAccessManager()->loadSettings();
    DB_InternetBrowserFactory::cookieJar()->loadSettings();
    DB_InternetBrowserFactory::historyManager()->loadSettings();
}
...
{
    CookiesDialog *dialog = new CookiesDialog(DB_InternetBrowserFactory::cookieJar(), this);
    dialog->exec();
}

void SettingsDialog::showExceptions()
{
    CookiesExceptionsDialog *dialog = new CookiesExceptionsDialog(DB_InternetBrowserFactory::cookieJar(), this);
    dialog->exec();
}
...
{
    DB_InternetBrowserWidget* wdgt = static_cast<DB_InternetBrowserWidget*>(parent());
    WebView* webView = wdgt->currentTab();
    if (webView)
