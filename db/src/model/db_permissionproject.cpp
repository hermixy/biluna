 ...
 * -perspective perspective code (e.g. ACC, CRM, MRP, SRM)
 * -persproject_idx, project number of a perspective
...
void DB_PermissionProject::createMembers() {
    addMember("perspective", "-", "", RB2::MemberChar125);
    addMember("persproject_idx", "-", "0", RB2::MemberChar165); // number
