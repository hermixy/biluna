...
#ifndef DB_INTERNETBROWSERWIDGET_H
...
public:
    DB_InternetBrowserWidget(QWidget* parent = 0, Qt::WindowFlags flags = 0);
    virtual ~DB_InternetBrowserWidget();
...
#endif // DB_INTERNETBROWSERWIDGET_H
