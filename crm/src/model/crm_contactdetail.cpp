/*****************************************************************
 * $Id: crm_contactdetail.cpp 1983 2013-09-02 18:10:02Z rutger $
 ...
 * Constructor
 */
CRM_ContactDetail::CRM_ContactDetail (const RB_String& id, RB_ObjectBase* p,
 ...
 * Constructor
 */
CRM_ContactDetail::CRM_ContactDetail(CRM_ContactDetail* obj) : RB_ObjectAtomic(obj) {
    createMembers();
    *this = *obj;
}
 ...
 * Destructor
 */
CRM_ContactDetail::~CRM_ContactDetail() {
