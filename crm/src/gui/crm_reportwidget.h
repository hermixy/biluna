/*****************************************************************
 * $Id: crm_reportwidget.h 1786 2012-10-01 20:24:24Z rutger $
...
#ifndef CRM_REPORTWIDGET_H
#define CRM_REPORTWIDGET_H
 ...
 * View report widget
 */
class CRM_ReportWidget : public RB_Widget {

    Q_OBJECT

public:
    explicit CRM_ReportWidget(QWidget *parent = 0);
    virtual ~CRM_ReportWidget();

    virtual RB_String getId() const { return RB_String(); }
    virtual RB_String getName() const { return "CRM Report"; }
