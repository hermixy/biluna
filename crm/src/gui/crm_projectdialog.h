/*****************************************************************
 * $Id: crm_projectdialog.h 1965 2013-08-08 16:33:15Z rutger $
...
#ifndef CRM_PROJECTDIALOG_H
#define CRM_PROJECTDIALOG_H
...
class CRM_ProjectDialog : public DB_TableDialog {

    Q_OBJECT

public:
    CRM_ProjectDialog(QWidget* parent) : DB_TableDialog(parent) {
        // HACK: for write settings otherwise RB_DialogBase
        this->setObjectName("CRM_ProjectDialog");
    }

    virtual ~CRM_ProjectDialog() {
    ...
    void init() {
        ...
        if (!DB_PERMISSIONHANDLER->isAdmin()) {
            ...
            DB_PERMISSIONHANDLER->getProjectIdList("CRM", projectIdList);
...
//        this->initTest();
        ...
        this->setHelpSubject("CRM_ProjectDialog");
        ...
        // Make sure there is one CRM_Project
