/*****************************************************************
 * $Id: crm_contactreportwidget.h 2132 2014-03-29 09:59:36Z rutger $
...
#ifndef CRM_CONTACTREPORTWIDGET_H
#define CRM_CONTACTREPORTWIDGET_H

#include "crm_reportwidget.h"
#include "ui_crm_contactreportwidget.h"
 ...
 */
class CRM_ContactReportWidget : public CRM_ReportWidget, private Ui::CRM_ContactReportWidget {

    Q_OBJECT

public:
    explicit CRM_ContactReportWidget(QWidget *parent = 0);
    virtual ~CRM_ContactReportWidget();

    virtual RB_String getId() const { return RB_String(); }
    virtual RB_String getName() const { return "Contact Report"; }
...
#endif // CRM_CONTACTREPORTWIDGET_H
