...
#define GV_MAXDOUBLE 1.0E+10
#define GV_MINDOUBLE -1.0E+10
...
/****************************************************************************
** $Id: gv.h 10544 2008-04-21 12:47:57Z andrew $
**
...
//public:
    ...
    /**
     * Variable types used by GV_VariableDict and GV_Variable.
     */
    enum VariableType {
        VariableString,
        VariableInt,
     ...
     * Wrapper for Qt
     */
    static GV2::ButtonState qtToRsButtonState(Qt::MouseButton t) {
        return (GV2::ButtonState)t;
    }
     ...
     * Wrapper for Qt
     */
    static Qt::PenStyle rsToQtLineType(GV2::LineType t) {
        switch (t) {
        case NoPen:
            return Qt::NoPen;
            break;
     ...
     * Wrapper for Qt.
     */
    static Qt::CursorShape rsToQtCursorType(GV2::CursorType t) {
        switch (t) {
        case Qt::ArrowCursor:
     ...
     * Wrapper for Qt.
     */
    static QPrinter::PageSize rsToQtPaperFormat(GV2::PaperFormat f) {
